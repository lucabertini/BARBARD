...
# (TUTTA LA CONFIGURAZIONE E LE FUNZIONI DI LOGGING RIMANGONO INVARIATE)
# ...
# --- CONFIGURAZIONE ---
# Cartelle
...
class Orchestrator:
    ...
    def _generate_music(self, lyrics: str, style: str) -> Optional[Path]:
        ...
        try:
            ...
            resp.raise_for_status() # Controlla errori HTTP (4xx, 5xx)
            
            response_json = resp.json()
            
            # --- BLOCCO DI CODICE MODIFICATO PER MAGGIORE ROBUSTEZZA ---
        ...
        for attempt in range(80):
            ...
            try:
                ...
                if status == "SUCCESS":
                    ...
                    # Nome file più corto per evitare problemi
    ...
    # (Tutte le altre funzioni della classe, come process_next_audio_file e run, rimangono invariate)
    # ...
